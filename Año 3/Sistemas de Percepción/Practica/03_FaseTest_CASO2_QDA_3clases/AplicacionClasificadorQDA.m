clear;
Color = [0 0 255];
ruta = '../02_FaseEntrenamiento_CASO2_QDA_3clases\DatosGenerados\QDA.mat';
load(ruta);
addpath('../Funciones');
...
for i=1:N
    ...
    [Yi, d]  = funcion_aplica_QDA(Xi, vectorMedias, matricesCovarianzas, probabilidadPriori, valoresClases);
